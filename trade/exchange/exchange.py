...
from trade import constant, OperationalException, DependencyException, TemporaryError
...
class Exchange(object):
    ...
    async def _async_get_history(self, pair: str,
        ...
        one_call = constant.TICKER_INTERVAL_MINUTES[tick_interval] * 60 * _LIMIT * 1000
    ...
    def _now_is_time_to_refresh(self, pair: str, ticker_interval: str) -> bool:
        ...
        interval_in_sec = constant.TICKER_INTERVAL_MINUTES[ticker_interval] * 60
