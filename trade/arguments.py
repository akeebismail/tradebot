...
class Arguments(object):
    ...
    def get_parsed_arg(self) -> argparse.Namespace:
        ...
        if self.parsed_arg is None:
            self._load_args()
            self.parsed_arg = self.parsed_args()
    ...
    def parse_args(self) -> argparse.Namespace:
        ...
        if parsed_arg.config is None:
            parsed_arg.config = [constant.DEFAULT_CONFIG]
        return parsed_arg
    ...
    def common_args_parser(self) -> None:
        ...
        self.parser.add_argument(
            '-v', '--verbose',
            help='Verbose mode(-vv for more, --vv to get all messages).',
            action='count',
            dest='loglevel',
            default=0
        )
        ...
        self.parser.add_argument(
            ...
            const=constant.DYNAMIC_WHITELIST,
            type=int,
            metavar='INT',
            nargs='?',
        )
    ...
    def hyperopt_options(parser: argparse.ArgumentParser) -> None:
        ...
        parser.add_argument(
            ...
            dest='hyperopt',
            default=constant.DEFAULT_HYPEROPT,
            type=str,
            metavar='NAME',
        )
        parser.add_argument(
        ...
        parser.add_argument(
            ...
            dest='epochs',
            default=constant.HYPEROPT_EPOCH,
            type=int,
            metavar='INT',
        )
        parser.add_argument(
    ...
    def _build_subcommands(self) -> None:
        ...
        :return: None
        """
        from trade.optimize import backtesting, hyperopt, edge_cli
